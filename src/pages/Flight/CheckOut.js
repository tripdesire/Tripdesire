...
class CheckOut extends React.PureComponent {
  ...
  navigateToScreen = (page, params = {}) => () => {
    ...
    let param = {
      ...
      onward_item_result_data:
        params.flightType == 1 && params.tripType == 1 ? params.departFlight : {},
      single_fl_name:
        params.flightType == 1
      ...
      return_fl_name:
        params.flightType == 2 && params.tripType == 2
          ...
          : "",
      return_fl_code:
        params.flightType == 2 && params.tripType == 2 ? params.departFlight.FlightUId : "",
      return_fl_from: params.flightType == 2 && params.tripType == 2 ? params.to : "",
      return_fl_to: params.flightType == 2 && params.tripType == 2 ? params.from : "",
      return_fl_time1: params.flightType == 2 && params.tripType == 2 ? dtReturn : "",
      return_fl_time2: params.flightType == 2 && params.tripType == 2 ? atReturn : "",
      return_fl_time_dur:
        params.flightType == 2 && params.tripType == 2
      ...
      return_fl_tax:
        params.flightType == 2 && params.tripType == 2
          ...
          : "",
      return_fl_dept_date:
        params.flightType == 2 && params.tripType == 2 ? departureDateReturn : "",
      return_fl_arriv_date: params.flightType == 2 && params.tripType == 2 ? arrivalDateReturn : "",
      ...
      return_fl_gst:
        ...
        params.departFlight.FareDetails.IsGSTMandatory == false
          ? 0
          : params.departFlight.FareDetails.IsGSTMandatory,
      fl_tot_price: params.departFlight.FareDetails.TotalFare,
