...
class HotelCheckout extends React.Component {
  ...
  render() {
    ...
    let checkOutDate = moment(params.checkOutDate, 'DD-MM-YYYY').format(
      'DD MMM',
    );
    return (
          ...
          <View
            ...
            <View
              ...
              <View
                ...
                <IconMaterial name="filter" fontSize={35} color="#ffffff" />
                <Text
                  style={{
                    fontSize: 12,
                    marginHorizontal: 5,
        ...
        <View style={{flex: 4, backgroundColor: '#FFFFFF'}}>
          <View
            ...
            <ScrollView
              ...
              <Text style={{fontSize: 18, flex: 1, marginTop: 10}}>
                Book your Hotels
              </Text>
                  ...
                  <View key={item.RoomIndex}>
                    <View style={{marginVertical: 20, flexDirection: 'row'}}>
                      ...
                      <View
                        ...
                        <View
                          style={{flex: 2, paddingStart: 4, marginStart: 10}}>
                          <Text
                            style={{
                              fontSize: 18,
                              fontWeight: '700',
                          ...
                          <Text style={{color: '#5B89F9', marginTop: 10}}>
                            Fare Policy
                          </Text>
                        </View>
                      </View>
                    ...
                    <View
                      style={{height: 1.35, backgroundColor: '#DDDDDD'}}></View>
                  </View>
                );
              })}
              ...
              <View style={{marginTop: 20}}>
                ...
                <View style={{flexDirection: 'row'}}>
                  ...
                  <Text
                    style={{color: '#717A81', flex: 4, paddingHorizontal: 10}}>
                    {params.Description}
                  </Text>
                </View>
                <View style={{flexDirection: 'row'}}>
